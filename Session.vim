...
badd +0 index.html
badd +1 app/app.go
badd +1 app/encoding.go
badd +0 app/pieces.go
argglobal
silent! argdel *
set stal=2
edit URLchess.go
...
wincmd w
argglobal
if bufexists('URLchess.css') | buffer URLchess.css | else | edit URLchess.css | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('app/encoding.go') | buffer app/encoding.go | else | edit app/encoding.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split")
nnoremap <buffer> <silent>  :call go#def#Jump("split")
nnoremap <buffer> <silent>  :GoDef
...
wincmd w
argglobal
if bufexists('app/pieces.go') | buffer app/pieces.go | else | edit app/pieces.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split")
nnoremap <buffer> <silent>  :call go#def#Jump("split")
nnoremap <buffer> <silent>  :GoDef
